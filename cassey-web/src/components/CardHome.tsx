export const CardHome = () => {
    return (
        <>
            ...
            <div className="pl-[15vh] pr-[15vh] pt-[5vh] flex flex-row justify-around">
                <div className="transition duration-500 ease-in-out transform hover:scale-105 transition duration-500 ease-in-out transform hover:scale-105 w-[35vh] max-w-sm bg-white rounded-[30px] shadow-customShadow dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img
                            className="p-8 rounded-t-lg"
                            src="https://cdn-image02.casetify.com/usr/29073/1469073/~v6692/15349384x2_iphone-15-pro__color_natural-titanium_16005986.png.1000x1000-w.m80.webp"
